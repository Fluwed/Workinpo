...
public class FluxRSS {
	...
	public void parse(String monfluxRSS,String Table) throws ClassNotFoundException, Exception{
		...
		while (itEntries.hasNext()) {
			try {
			SyndEntry entry = itEntries.next(); // entry correspond a toute les balises que contient la balise <item> sur laquel pointe itEntries
	...
	public String Affiche(String Table) throws SQLException, ClassNotFoundException{   
